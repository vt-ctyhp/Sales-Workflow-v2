const PERMISSIONS = Object.freeze({
  ...
  'Api.diamonds.inStock': Object.freeze([ROLE.ADMIN, ROLE.DIAMOND_ORDER_ADMIN, ROLE.DIAMOND_ORDER_ASSISTANT]),
  'Api.diamonds.tracking': Object.freeze([ROLE.ADMIN, ROLE.DIAMOND_ORDER_ADMIN, ROLE.DIAMOND_ORDER_ASSISTANT]),
  'Api.diamonds.bulkReturnCandidates': Object.freeze([ROLE.ADMIN, ROLE.DIAMOND_ORDER_ADMIN]),
  'Api.diamonds.bulkMarkReturnInProgress': Object.freeze([ROLE.ADMIN, ROLE.DIAMOND_ORDER_ADMIN]),
  'Api.diamonds.assignInStock': Object.freeze([ROLE.ADMIN, ROLE.DIAMOND_ORDER_ADMIN]),
  'Api.diamonds.byRoot': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC, ROLE.DIAMOND_ORDER_ADMIN, ROLE.DIAMOND_ORDER_ASSISTANT, ROLE.READ_ONLY_VIEWER]),
  ...
  'Api.diamonds.previewLoupe360Sync': Object.freeze([ROLE.ADMIN, ROLE.DIAMOND_ORDER_ADMIN]),
  'Api.diamonds.applyLoupe360Sync': Object.freeze([ROLE.ADMIN, ROLE.DIAMOND_ORDER_ADMIN]),

  'Api.payments.init': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC]),
  'Api.payments.validatePrerequisites': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC]),
  'Api.payments.submit': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC]),
  'Api.payments.regenerateDoc': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC]),
  'Api.payments.submitCombo': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC]),
  'Api.payments.history': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC, ROLE.READ_ONLY_VIEWER]),
  'Api.payments.getDocLinks': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC, ROLE.READ_ONLY_VIEWER]),
  'Api.payments.exportPdf': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC]),
  'Api.payments.reset': Object.freeze([ROLE.ADMIN]),
  'Api.payments.adminVoid': Object.freeze([ROLE.ADMIN]),
  ...
  'Api.diag.triggerStatus': Object.freeze([ROLE.ADMIN]),
  'Api.diag.logClientTiming': Object.freeze([ROLE.ADMIN, ROLE.CLIENT_ADVISOR, ROLE.JOC, ROLE.DIAMOND_ORDER_ADMIN, ROLE.DIAMOND_ORDER_ASSISTANT, ROLE.READ_ONLY_VIEWER]),
});
